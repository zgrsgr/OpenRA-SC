...
WorldLoaded = function()
	...
	alliedObjective = enemy.AddPrimaryObjective("消灭苏军部队。")
	sovietObjective = player.AddPrimaryObjective("护送车队。")
	sovietObjective2 = player.AddSecondaryObjective("摧毁或占领盟军雷达站以阻止敌人呼叫增援。")
	SaveAllTrucks = player.AddSecondaryObjective("不损失任意一辆卡车。")
end
