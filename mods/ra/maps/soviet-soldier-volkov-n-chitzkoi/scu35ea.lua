...
--Objectives Setup
	...
	Trigger.OnKilled(ControlCenter, function()
		...
		DestroyAlloyFacility = player.AddPrimaryObjective("摧毁合金加工设施。")
		Media.PlaySpeechNotification(player, "FirstObjectiveMet")
		Media.DisplayMessage("干得漂亮！重型炮塔控制中心被摧毁了，\n现在我们可以进攻合金加工设施了。", "战场控制")
	end)
...
ChitzkoiIsDead = function(a)
	Trigger.OnKilled(a, function()
		...
		Media.DisplayMessage("别担心，，我们掌握了相关的技术，可以重建契琴科伊。", "战场控制")
		Trigger.AfterDelay(DateTime.Seconds(1), function()
