...
WorldLoaded = function()
	...
	NodObjective1 = player.AddPrimaryObjective("清空首个着陆区")
	NodObjective2 = player.AddPrimaryObjective("清空第二个着陆区")
	NodObjective3 = player.AddPrimaryObjective("确认Nod基地位置")
	NodObjective4 = player.AddPrimaryObjective("占领泰伯利亚精炼厂")
	NodObjective5 = player.AddPrimaryObjective("肃清GDI所有武装力量")
	NodObjective6 = player.AddSecondaryObjective("建造三个防空导弹平台抵御GDI空袭")
