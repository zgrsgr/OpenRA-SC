...
function WorldLoaded()
	...
	warFactoryObjective = player.AddPrimaryObjective("占领或摧毁GDI战车工厂")
	destroyTanksObjective = player.AddPrimaryObjective("摧毁科研设施内的所有猛犸坦克")
	keepRamboAliveObjective = player.AddSecondaryObjective("确保突击队员存活")
