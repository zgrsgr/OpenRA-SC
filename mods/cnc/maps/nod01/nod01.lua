...
WorldLoaded = function()
	...
	NodObjective1 = player.AddPrimaryObjective("除掉尼寇穆巴")
	NodObjective2 = player.AddPrimaryObjective("摧毁整个村庄")
	NodObjective3 = player.AddSecondaryObjective("肃清所有GDI武装力量")
	GDIObjective1 = enemy.AddPrimaryObjective("消灭Nod")
