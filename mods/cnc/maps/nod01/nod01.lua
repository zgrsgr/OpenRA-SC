...
WorldLoaded = function()
	...
	KillNikoomba = Nod.AddObjective("除掉尼寇穆巴")
	DestroyVillage = Nod.AddObjective("摧毁整个村庄")
	DestroyGDI = Nod.AddObjective("肃清所有GDI武装力量", "次要目标", false)
	GDIObjective = GDI.AddObjective("消灭Nod")
